function CreditsScene() {
  ...
  this.draw = function() {
    ...
    drawText('Annual Saga Monthly Game 2 (May 2018)', GAME_WIDTH/2, 150, 'black', 'center', 'middle');
    drawText('David\'s World 2 Prototype', GAME_WIDTH/2, 200, 'black', 'center', 'middle');
